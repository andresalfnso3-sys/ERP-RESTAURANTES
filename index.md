...
|---|---|
| [Nombre 1] | [ej. Definición del problema, Solución ofrecida] |
| [Nombre 2] | [ej. Justificación, Usuario final, Utilidad] |
| [Nombre 3] | [ej. Antecedentes, Requisitos funcionales, Alcance] |
| Diego L. | Requisitos no funcionales, Tecnologías seleccionadas, Repositorio |
...
## Guide 1 — Infografía y video

- Infografía (resumen del artículo de arquitectura de software): ver carpeta `/docs/assets` o el
  archivo adjunto en el informe de laboratorio.
- Video explicativo: [enlace pendiente de publicar en el foro FORUM Guide 1]

## Enlaces

- Repositorio: `https://github.com/<usuario-o-equipo>/<nombre-del-repo>`
- Tablero de tareas: _[opcional: Trello/Notion/GitHub Projects]_
